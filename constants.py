...
class DriveConstants:
    ...
    kPhysicalMaxSpeedMetersPerSecond = 2 #5 MPS is about 11 miles per hour 
    kModeSidewaysSpeedMetersPerSecond = 0.15
    ...
    kTeleDriveMaxSpeedMetersPerSecond = 5 #.45 #17*0.3048 #17 feet per second into meters
